...
function AppContent() {
  ...
  const handleLoadReport = async () => {
    if (!process.env.REACT_APP_CLICKUP_TOKEN) {
      setError(
        "ClickUp токен не найден. Добавьте REACT_APP_CLICKUP_TOKEN в .env файл"
      );
      return;
    }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {activeTab === "analytics" && (
          <>
            ...
            {error && (
              <div
                className="scale-in rounded-xl p-6 text-center mb-8 border"
                style={{
              ...
              >
                ...
                {error.includes("токен") && (
                  ...
                  >
                    ...
                    <code
                      className="block text-sm p-3 rounded-lg font-mono"
                      style={{
            ...
            {!reportData && !loading && !error && (
              <div className="text-center py-12 fade-in">
                ...
                <div
                  className="max-w-lg mx-auto text-left rounded-xl p-6 border"
                  style={{
                    backgroundColor: "var(--bg-primary)",
                    borderColor: "#3b82f6",
                  }}
                >
                  ...
                  >
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Добавьте его в .env файл как REACT_APP_CLICKUP_TOKEN
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span
